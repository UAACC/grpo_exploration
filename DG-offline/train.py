...
def parse_args():
    p = argparse.ArgumentParser(description="Delightful offline GRPO training.")
    # Model
...
def main():
    ...
    if args.run_name is None:
        ...
        args.run_name = f"dg-offline-{model_name}-eta{args.dg_temperature}-{time_str}"
